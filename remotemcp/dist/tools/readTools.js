...
export const getReadTools = () => [
    ...
    },
    {
        ...
        handler: async (args) => {
            try {
                const empNumber = args['empNumber'];
    ...
    },
    {
        ...
        handler: async (args) => {
            try {
                const leaveTypeId = args['leaveTypeId'];
                const response = await apiGet(`/api/v2/leave/leave-balances/my-leave-balance`, { leaveTypeId });
    ...
    },
    {
        ...
        handler: async (args) => {
            try {
                ...
                const response = await apiGet(`/api/v2/time/projects/${projectId}/activities`);
...
//# sourceMappingURL=readTools.js.map